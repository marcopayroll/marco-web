...
window.MARCO_LANG_CN_HUB_MEMO = {
  ...
  'memo.hero.title': '',
  'memo.hero.sub': '',
  'memo.card.malaysia-lindung-opt-out.time': '',
  'memo.card.malaysia-lindung-opt-out.title': '',
  'memo.card.malaysia-lindung-update.time': '',
  'memo.card.malaysia-lindung-update.title': '',

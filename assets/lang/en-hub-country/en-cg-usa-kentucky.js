/* Country Guide - USA - Kentucky page content (hr-knowledge-hub-country-guide-usa-kentucky.html) */
...
window.MARCO_LANG_EN_CG_USA_KENTUCKY = {
  ...
  'cg.usa-kentucky.kn3.note': `Effective 2026/1 (Reduced from 4.0%)`,

  'cg.usa-kentucky.s1.h': `Cost of Living`,

  'cg.usa-kentucky.s1.title': `City consumption level: Louisville / Lexington / Bowling Green`,

  'cg.usa-kentucky.s1.sub': `Based on publicly available consumption data, for reference only (US$ US Dollar, 2026 early)`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Public Transit Monthly Pass (Louisville TARC)</td><td>Approx. $ 50</td></tr>
                <tr><td>City Center 1 Bedroom (Louisville Downtown)</td><td>Approx. $ 1,100 &ndash; 1,600 / Month</td></tr>
                <tr><td>Suburban 1 Bedroom (Lexington)</td><td>Approx. $ 950 &ndash; 1,400 / Month</td></tr>
                <tr><td>Single Person Minimum Monthly Expenses</td><td>Approx. $ 1,000 &ndash; 1,500 (Excluding Rent)</td></tr>
                <tr><td>Single Person Decent Living (Including Rent, Month)</td><td>Approx. $ 2,500 &ndash; 3,800</td></tr>
              </tbody>
            </table>
          </div>
`,

  'cg.usa-kentucky.s2.h': `Salary Benchmark`,

  'cg.usa-kentucky.s2.sub': `Kentucky has no state minimum wage, adopts federal $7.25/hour, state flat tax reduced to 3.5% effective 2026/1. Logistics / Automotive / Bourbon whiskey.`,
  ...
  'cg.usa-kentucky.s2.b1': `
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              ...
              <span>Kentucky household income median approximately $61,000/year. Louisville UPS Global Air Hub (Worldport)</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Logistics (UPS Worldport), Automotive (Toyota / Ford), Bourbon whiskey, Healthcare as pillars</span>
            </li>
          </ul>
`,
  ...
  'cg.usa-kentucky.s2.b2': `
          ...
          <p class="cg-table-note">Note: Louisville (UPS Logistics / Medical), Lexington (Toyota / Horse Industry), living costs nationally low, work-friendly state.</p>
`,

  'cg.usa-kentucky.s3.h': `Statutory Benefits`,

  'cg.usa-kentucky.s3.sub': `Federal social insurance (FICA) employer-employee split contribution + Federal/State unemployment insurance (FUTA/SUTA, employer sole contribution) + Work injury insurance`,
  ...
  'cg.usa-kentucky.s3.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>SUTA KY State Unemployment Tax</td><td>0.3 - 9%</td><td>&ndash;</td><td>First $11,700 wages, new employer 2.7%</td></tr>
                <tr><td>Workers&rsquo; Comp Work Injury Insurance</td><td>~0.5 - 2%</td><td>&ndash;</td><td>All employees mandatory, by industry risk rate</td></tr>
          ...
          <p class="cg-table-note">USA has no statutory paid annual leave / sick leave (federal level). FICA combined: employer 7.65% + employee 7.65%. Kentucky has no state mandatory paid sick leave.</p>
`,

  'cg.usa-kentucky.s3.b2': `
          <p class="au-table-title">Employer Statutory Additional Cost Summary (Kentucky, as % of Base Salary)</p>
          <p class="au-section-sub">FICA 7.65%, FUTA 0.6%, SUTA 0.3 - 9%, Work Injury ~0.5 - 2%</p>
...
`,
  ...
  'cg.usa-kentucky.s4.h': `Personal Income Tax`,

  'cg.usa-kentucky.s4.sub': `Federal progressive 7 tiers (employer monthly withholding W-4) + State income tax. Fiscal year 1/1 - 12/31, April filing.`,
...
`,
  ...
  'cg.usa-kentucky.s4.b2': `
          <p class="au-section-title">State Income Tax KY &mdash; Flat 3.5% (Effective 2026)</p>
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Kentucky individual tax 2026/1 reduced to 3.5% (from 4.0%, HB1 legislation), progressively moving toward elimination</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Many counties / cities additionally levy Occupational Tax: Louisville 2.2%, Lexington 2.25%</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Sales tax flat 6% (No local additional), prescription drugs / grocery tax-exempt</span>
            </li>
          </ul>
`,

  'cg.usa-kentucky.s5.h': `Working Hours`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Daily Working Hours Cap</td><td>No federal cap</td><td>By 40h/week calculation, KY state no additional daily cap</td></tr>
                <tr><td>Weekly Rest Day</td><td>No federal mandate</td><td>Determined by employer / contract</td></tr>
                <tr><td>Meal / Rest Breaks</td><td>No federal mandate</td><td>Kentucky: Work &ge; 3.5h must have paid break, 5h onwards must have meal break</td></tr>
...
`,
  ...
  'cg.usa-kentucky.s5.b2': `
          ...
          <ul class="au-bullet-list">
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Kentucky overtime follows federal FLSA 1.5&times;, seventh consecutive workday additionally requires 1.5&times;</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Most US states do not mandate daily overtime calculation. Only California and a few states calculate by 8h/day. KY calculates by 40h/week</span>
            </li>
          </ul>
`,

  'cg.usa-kentucky.s6.h': `Employment Contracts`,
  ...
  'cg.usa-kentucky.s6.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>At-Will Employment</td><td>Default form</td><td>Employer / Employee can terminate at any time without cause (KY applicable)</td></tr>
                ...
                <tr><td>Non-Compete (Non-Compete)</td><td>Enforceable (Reasonable scope)</td><td>FTC proposed nationwide ban (pending), KY current regulations</td></tr>
...
`,
  ...
  'cg.usa-kentucky.s7.h': `Leave Entitlements`,
            ...
            <table class="au-table" style="table-layout:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Employer discretion, Kentucky has no paid sick leave law</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>FMLA 12 weeks unpaid, KY no state paid maternity leave</td>
                </tr>
                <tr>
...
`,
  ...
  'cg.usa-kentucky.s8.h': `Public Holidays 2026`,

  'cg.usa-kentucky.s8.sub': `Total 11 federal holidays (Banks / Government holidays). Private employers not mandatory paid. KY additionally designates several state holidays.`,
  ...
  'cg.usa-kentucky.s8.b1': `
          ...
          <p class="cg-table-note">Federal holidays only bind federal institutions and banks. Private enterprises may decide at their own discretion whether to grant time off / paid leave. KY additionally designates approximately 1-2 state holidays.</p>
`,

  'cg.usa-kentucky.s9.h': `Key Regulations`,
  ...
  'cg.usa-kentucky.s9.b1': `
          <div class="cg-reg-item">
            ...
            <p class="cg-reg-body">Federal core labor law, stipulating minimum wage $7.25 / Overtime 1.5&times; / Child labor / Time records. Enforced by US DOL. KY applies federal standards.</p>
          </div>
          <div class="cg-reg-item">
          ...
          <div class="cg-reg-item">
            <p class="cg-reg-title">Kentucky HB 1 (2025) &mdash; Tax Reduction Act</p>
            <p class="cg-reg-body">2025 legislation, individual income tax rate reduced from 4.0% to 3.5% effective 2026/1, trigger mechanism designed to progressively move toward 0%, business-friendly.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">Kentucky Right-to-Work + Local Occupational Tax</p>
            <p class="cg-reg-body">2017 Right-to-Work state (No mandatory union membership), but many counties/cities levy Occupational Tax (Occupational License Tax, approx. 1-2.5%) withheld from wages.</p>
          </div>
          <div class="cg-reg-item">

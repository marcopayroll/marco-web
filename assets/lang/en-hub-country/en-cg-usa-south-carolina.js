...
window.MARCO_LANG_EN_CG_USA_SOUTH_CAROLINA = {
  ...
  'cg.usa-south-carolina.s1.title': `City consumption level: Charleston / Columbia / Greenville`,

  'cg.usa-south-carolina.s1.sub': `Based on publicly available consumption data, for reference only (US$ US Dollar, 2026 early)`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Public Transit Monthly Pass (Charleston CARTA)</td><td>Approx. $ 55</td></tr>
                <tr><td>City Center 1 Bedroom (Charleston Downtown)</td><td>Approx. $ 1,800 &ndash; 2,500 / Month</td></tr>
                <tr><td>Suburban 1 Bedroom (Columbia)</td><td>Approx. $ 1,100 &ndash; 1,500 / Month</td></tr>
                <tr><td>Single Person Minimum Monthly Expenses</td><td>Approx. $ 1,100 &ndash; 1,600 (Excluding Rent)</td></tr>
                <tr><td>Single Person Decent Living (Including Rent, Month)</td><td>Approx. $ 2,800 &ndash; 4,200</td></tr>
              </tbody>
            </table>
          </div>
`,

  'cg.usa-south-carolina.s2.h': `Salary Benchmark`,

  'cg.usa-south-carolina.s2.sub': `South Carolina has no state minimum wage, adopts federal $7.25/hour, state progressive tax top tier 6.2% (Being continuously reduced). Automotive / Aerospace manufacturing.`,
  ...
  'cg.usa-south-carolina.s2.b1': `
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              ...
              <span>South Carolina household income median approximately $67,000/year. Manufacturing (BMW / Volvo) + Port logistics (Charleston) robust</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Automotive (BMW Spartanburg), Aerospace (Boeing Charleston), Tires (Michelin) as pillar industries</span>
            </li>
          </ul>
`,
  ...
  'cg.usa-south-carolina.s2.b2': `
          ...
          <p class="cg-table-note">Note: Greenville (BMW / Manufacturing), Charleston (Boeing / Port), manufacturing foreign investment concentrated, work-friendly state.</p>
`,

  'cg.usa-south-carolina.s3.h': `Statutory Benefits`,

  'cg.usa-south-carolina.s3.sub': `Federal social insurance (FICA) employer-employee split contribution + Federal/State unemployment insurance (FUTA/SUTA, employer sole contribution) + Work injury insurance`,
  ...
  'cg.usa-south-carolina.s3.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>SUTA SC State Unemployment Tax</td><td>0.06 - 5.4%</td><td>&ndash;</td><td>First $14,000 wages, new employer approx. 0.41%</td></tr>
                <tr><td>Workers&rsquo; Comp Work Injury Insurance</td><td>~0.5 - 2%</td><td>&ndash;</td><td>4+ employees mandatory, by industry risk rate</td></tr>
          ...
          <p class="cg-table-note">USA has no statutory paid annual leave / sick leave (federal level). FICA combined: employer 7.65% + employee 7.65%. South Carolina has no state mandatory paid sick leave.</p>
`,

  'cg.usa-south-carolina.s3.b2': `
          <p class="au-table-title">Employer Statutory Additional Cost Summary (South Carolina, as % of Base Salary)</p>
          <p class="au-section-sub">FICA 7.65%, FUTA 0.6%, SUTA 0.06 - 5.4%, Work Injury ~0.5 - 2%</p>
...
`,
  ...
  'cg.usa-south-carolina.s4.h': `Personal Income Tax`,

  'cg.usa-south-carolina.s4.sub': `Federal progressive 7 tiers (employer monthly withholding W-4) + State income tax. Fiscal year 1/1 - 12/31, April filing.`,
...
`,
  ...
  'cg.usa-south-carolina.s4.b2': `
          <p class="au-section-title">State Income Tax SC &mdash; Progressive 0 &ndash; 6.2% (Being Reduced Annually)</p>
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>South Carolina individual tax progressive 3 tiers: $0-3,560 exempt, mid-tier 3%, above approx. $17,830 top tier 6.2%</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Top tier tax rate ongoing reduction plan (Target reduction to 6.0%), pegged to federal taxable income</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Sales tax: State 6% + Local up to 3% (Combined approx. 7-9%), grocery tax-exempt</span>
            </li>
          </ul>
`,

  'cg.usa-south-carolina.s5.h': `Working Hours`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Daily Working Hours Cap</td><td>No federal cap</td><td>By 40h/week calculation, SC state no additional daily cap</td></tr>
                <tr><td>Weekly Rest Day</td><td>No federal mandate</td><td>Determined by employer / contract</td></tr>
                <tr><td>Meal / Rest Breaks</td><td>No federal mandate</td><td>South Carolina has no state mandatory meal / rest break regulations, follows employer policy</td></tr>
...
`,
  ...
  'cg.usa-south-carolina.s5.b2': `
          ...
          <ul class="au-bullet-list">
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>South Carolina has no state overtime law, fully applies federal FLSA 1.5&times; standard</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Most US states do not mandate daily overtime calculation. Only California and a few states calculate by 8h/day. SC calculates by 40h/week</span>
            </li>
          </ul>
`,

  'cg.usa-south-carolina.s6.h': `Employment Contracts`,
  ...
  'cg.usa-south-carolina.s6.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>At-Will Employment</td><td>Default form</td><td>Employer / Employee can terminate at any time without cause (SC applicable)</td></tr>
                ...
                <tr><td>Non-Compete (Non-Compete)</td><td>Enforceable (Reasonable scope)</td><td>FTC proposed nationwide ban (pending), SC current regulations</td></tr>
...
`,
  ...
  'cg.usa-south-carolina.s7.h': `Leave Entitlements`,
            ...
            <table class="au-table" style="table-layout:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>No state mandate</td>
                  <td>Employer discretion, South Carolina has no paid sick leave law</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>FMLA 12 weeks unpaid, SC no state paid maternity leave</td>
                </tr>
                <tr>
...
`,
  ...
  'cg.usa-south-carolina.s8.h': `Public Holidays 2026`,

  'cg.usa-south-carolina.s8.sub': `Total 11 federal holidays (Banks / Government holidays). Private employers not mandatory paid. SC additionally designates several state holidays.`,
  ...
  'cg.usa-south-carolina.s8.b1': `
          ...
          <p class="cg-table-note">Federal holidays only bind federal institutions and banks. Private enterprises may decide at their own discretion whether to grant time off / paid leave. SC additionally designates approximately 1-2 state holidays.</p>
`,

  'cg.usa-south-carolina.s9.h': `Key Regulations`,
  ...
  'cg.usa-south-carolina.s9.b1': `
          <div class="cg-reg-item">
            ...
            <p class="cg-reg-body">Federal core labor law, stipulating minimum wage $7.25 / Overtime 1.5&times; / Child labor / Time records. Enforced by US DOL. SC applies federal standards.</p>
          </div>
          <div class="cg-reg-item">
          ...
          <div class="cg-reg-item">
            <p class="cg-reg-title">South Carolina Right-to-Work &mdash; Right-to-Work Law</p>
            <p class="cg-reg-body">South Carolina is a Right-to-Work state, employees not required to join unions or pay dues. Union density among lowest in the US. Beneficial for foreign investment in manufacturing.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">SC Payment of Wages Act &mdash; Wage Payment Act</p>
            <p class="cg-reg-body">Requires employers to provide written notice of wage standards / pay schedule. Separation wages must be paid within 48 hours or by next pay date. Violations subject to double damages.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">ACA / COBRA / IRCA &mdash; Medical Insurance and Employment Compliance</p>
            <p class="cg-reg-body">ACA: 50+ full-time employee employers must provide medical insurance. COBRA: Post-termination continuation coverage 18 months. IRCA: I-9 form verifying work authorization (E-Verify mandatory for all employees).</p>
          </div>
`,
};

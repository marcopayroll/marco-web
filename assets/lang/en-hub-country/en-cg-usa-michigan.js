...
window.MARCO_LANG_EN_CG_USA_MICHIGAN = {
  'cg.usa-michigan.kn1.label': `Minimum Wage (2026)`,

  'cg.usa-michigan.kn1.value': `$ 13.73`,

  'cg.usa-michigan.kn1.unit': `/ hr`,

  'cg.usa-michigan.kn1.note': `2026/1 effective (2027 rising to $15.00)`,

  'cg.usa-michigan.kn2.label': `Employer Statutory Additional Cost`,

  'cg.usa-michigan.kn2.value': `~8-12%`,

  'cg.usa-michigan.kn2.note': `FICA 7.65% + FUTA 0.6% + SUTA + Work Injury`,

  'cg.usa-michigan.kn3.label': `State Personal Income Tax`,

  'cg.usa-michigan.kn3.value': `4.25%`,

  'cg.usa-michigan.kn3.note': `Unified flat tax rate, some cities additionally levy local tax`,

  'cg.usa-michigan.s1.h': `Cost of Living`,

  'cg.usa-michigan.s1.title': `City consumption level: Detroit / Grand Rapids / Ann Arbor`,

  'cg.usa-michigan.s1.sub': `Based on publicly available consumption data, for reference only (US$ US Dollar, 2026 early)`,
  ...
  'cg.usa-michigan.s1.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>Fast Food Meal Set</td><td>Approx. $ 9 &ndash; 11</td></tr>
                <tr><td>Public Transit Monthly Pass (Detroit DDOT)</td><td>Approx. $ 70</td></tr>
                <tr><td>City Center 1 Bedroom (Detroit Midtown)</td><td>Approx. $ 1,200 &ndash; 1,800 / Month</td></tr>
                <tr><td>Suburban 1 Bedroom (Grand Rapids)</td><td>Approx. $ 1,200 &ndash; 1,600 / Month</td></tr>
                <tr><td>Single Person Minimum Monthly Expenses</td><td>Approx. $ 1,100 &ndash; 1,600 (Excluding Rent)</td></tr>
                <tr><td>Single Person Decent Living (Including Rent, Month)</td><td>Approx. $ 2,600 &ndash; 3,800</td></tr>
              </tbody>
            </table>
          </div>
`,

  'cg.usa-michigan.s2.h': `Salary Benchmark`,

  'cg.usa-michigan.s2.sub': `Michigan 2026/1 minimum wage $13.73/hour (2027 rising to $15.00), state flat tax 4.25%. Automotive industry center.`,
  ...
  'cg.usa-michigan.s2.b1': `
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              ...
              <span>Michigan household income median approximately $69,000/year. Detroit is home to three major automakers (GM / Ford / Stellantis) headquarters</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Automotive manufacturing (GM / Ford / Stellantis), Automation / EV / Battery, University town (Ann Arbor) technology research</span>
            </li>
          </ul>
`,
  ...
  'cg.usa-michigan.s2.b2': `
          ...
          <p class="cg-table-note">Note: Detroit (Automotive / Manufacturing), Grand Rapids (Furniture / Medical). Some cities (Detroit 2.4%) additionally levy local income tax.</p>
`,

  'cg.usa-michigan.s3.h': `Statutory Benefits`,

  'cg.usa-michigan.s3.sub': `Federal social insurance (FICA) employer-employee split contribution + Federal/State unemployment insurance (FUTA/SUTA, employer sole contribution) + Work injury insurance`,
  ...
  'cg.usa-michigan.s3.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>SUTA MI State Unemployment Tax</td><td>0.06 - 10.3%</td><td>&ndash;</td><td>First $9,500 wages, new employer 2.7%</td></tr>
                <tr><td>Workers&rsquo; Comp Work Injury Insurance</td><td>~0.5 - 2%</td><td>&ndash;</td><td>All employees (1+) mandatory, by industry risk rate</td></tr>
          ...
          <p class="cg-table-note">USA has no statutory paid annual leave / sick leave (federal level). FICA combined: employer 7.65% + employee 7.65%. Michigan mandatory paid sick leave effective 2025/2 (ESTA).</p>
`,

  'cg.usa-michigan.s3.b2': `
          <p class="au-table-title">Employer Statutory Additional Cost Summary (Michigan, as % of Base Salary)</p>
          <p class="au-section-sub">FICA 7.65%, FUTA 0.6%, SUTA 0.06 - 10.3%, Work Injury ~0.5 - 2%</p>
...
`,
  ...
  'cg.usa-michigan.s4.h': `Personal Income Tax`,

  'cg.usa-michigan.s4.sub': `Federal progressive 7 tiers (employer monthly withholding W-4) + State income tax. Fiscal year 1/1 - 12/31, April filing.`,
...
`,
  ...
  'cg.usa-michigan.s4.b2': `
          <p class="au-section-title">State Income Tax MI &mdash; Flat 4.25%</p>
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Michigan individual tax unified flat 4.25% (Non-progressive), 2023 temporarily reduced to 4.05%, subsequently reverted</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Some cities additionally levy local income tax: Detroit 2.4% (Residents), Grand Rapids 1.5%, etc.</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Sales tax flat 6% (No local additional), food / prescription drugs tax-exempt</span>
            </li>
          </ul>
`,

  'cg.usa-michigan.s5.h': `Working Hours`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Daily Working Hours Cap</td><td>No federal cap</td><td>By 40h/week calculation, MI state no additional daily cap</td></tr>
                <tr><td>Weekly Rest Day</td><td>No federal mandate</td><td>Determined by employer / contract</td></tr>
                <tr><td>Meal / Rest Breaks</td><td>No federal mandate</td><td>Michigan has no state mandatory adult meal / rest break regulations (Minors excluded)</td></tr>
...
`,
  ...
  'cg.usa-michigan.s5.b2': `
          ...
          <ul class="au-bullet-list">
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Michigan overtime follows federal FLSA 1.5&times;, beyond 40h/week, state law consistent</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Most US states do not mandate daily overtime calculation. Only California and a few states calculate by 8h/day. MI calculates by 40h/week</span>
            </li>
          </ul>
`,

  'cg.usa-michigan.s6.h': `Employment Contracts`,
  ...
  'cg.usa-michigan.s6.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>At-Will Employment</td><td>Default form</td><td>Employer / Employee can terminate at any time without cause (MI applicable)</td></tr>
                ...
                <tr><td>Non-Compete (Non-Compete)</td><td>Enforceable (Reasonable scope)</td><td>FTC proposed nationwide ban (pending), MI current regulations</td></tr>
...
`,
  ...
  'cg.usa-michigan.s7.h': `Leave Entitlements`,
            ...
            <table class="au-table" style="table-layout:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>State mandatory (ESTA)</td>
                  <td>Effective 2025/2, small enterprise 40h / large enterprise 72h</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>FMLA 12 weeks unpaid, MI no state paid maternity leave</td>
                </tr>
                <tr>
...
`,
  ...
  'cg.usa-michigan.s8.h': `Public Holidays 2026`,

  'cg.usa-michigan.s8.sub': `Total 11 federal holidays (Banks / Government holidays). Private employers not mandatory paid. MI additionally designates several state holidays.`,
  ...
  'cg.usa-michigan.s8.b1': `
          ...
          <p class="cg-table-note">Federal holidays only bind federal institutions and banks. Private enterprises may decide at their own discretion whether to grant time off / paid leave. MI additionally designates approximately 1-2 state holidays.</p>
`,

  'cg.usa-michigan.s9.h': `Key Regulations`,
  ...
  'cg.usa-michigan.s9.b1': `
          <div class="cg-reg-item">
            ...
            <p class="cg-reg-body">Federal core labor law, stipulating minimum wage $7.25 / Overtime 1.5&times; / Child labor / Time records. Enforced by US DOL. MI applies federal standards.</p>
          </div>
          <div class="cg-reg-item">
          ...
          <div class="cg-reg-item">
            <p class="cg-reg-title">Michigan ESTA &mdash; Paid Sick Leave Act (2025/2 Effective)</p>
            <p class="cg-reg-body">2025/2/21 effective. Small enterprises (&le;10 people) maximum 40h paid sick leave per year, large enterprises maximum 72h. Accrued by hours worked.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">Michigan Right-to-Work Repeal (2024) &mdash; Union Provisions</p>
            <p class="cg-reg-body">2024/3 repealed Right-to-Work law (first in US history to reverse). Unions may renegotiate mandatory dues provisions. Public sector excluded.</p>
          </div>
          <div class="cg-reg-item">

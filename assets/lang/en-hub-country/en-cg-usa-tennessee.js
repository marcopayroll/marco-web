...
window.MARCO_LANG_EN_CG_USA_TENNESSEE = {
  ...
  'cg.usa-tennessee.kn3.note': `No state personal income tax (Hall Tax 2021 abolished)`,

  'cg.usa-tennessee.s1.h': `Cost of Living`,

  'cg.usa-tennessee.s1.title': `City consumption level: Nashville / Memphis / Knoxville / Chattanooga`,

  'cg.usa-tennessee.s1.sub': `Based on publicly available consumption data, for reference only (US$ US Dollar, 2026 early)`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Public Transit Monthly Pass (Nashville WeGo)</td><td>Approx. $ 65</td></tr>
                <tr><td>City Center 1 Bedroom (Nashville Downtown)</td><td>Approx. $ 1,800 &ndash; 2,400 / Month</td></tr>
                <tr><td>Suburban 1 Bedroom (Murfreesboro)</td><td>Approx. $ 1,300 &ndash; 1,700 / Month</td></tr>
                <tr><td>Single Person Minimum Monthly Expenses</td><td>Approx. $ 1,200 &ndash; 1,800 (Excluding Rent)</td></tr>
                <tr><td>Single Person Decent Living (Including Rent, Month)</td><td>Approx. $ 3,000 &ndash; 4,500</td></tr>
              </tbody>
            </table>
          </div>
`,

  'cg.usa-tennessee.s2.h': `Salary Benchmark`,

  'cg.usa-tennessee.s2.sub': `Tennessee has no state minimum wage, adopts federal $7.25/hour, no state personal income tax &mdash; high take-home pay, attracting enterprise relocation.`,
  ...
  'cg.usa-tennessee.s2.b1': `
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              ...
              <span>Tennessee household income median approximately $67,000/year. Nashville automotive / Healthcare / Music industry hub</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Manufacturing (Nissan / Volkswagen), Healthcare (HCA Nashville HQ), Logistics (FedEx Memphis HQ) as pillar industries</span>
            </li>
          </ul>
`,
  ...
  'cg.usa-tennessee.s2.b2': `
          ...
          <p class="cg-table-note">Note: Nashville (Healthcare / Music), Memphis (FedEx / Logistics), no state personal tax making Tennessee a popular relocation destination.</p>
`,

  'cg.usa-tennessee.s3.h': `Statutory Benefits`,

  'cg.usa-tennessee.s3.sub': `Federal social insurance (FICA) employer-employee split contribution + Federal/State unemployment insurance (FUTA/SUTA, employer sole contribution) + Work injury insurance`,
  ...
  'cg.usa-tennessee.s3.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>SUTA TN State Unemployment Tax</td><td>0.01 - 10%</td><td>&ndash;</td><td>First $7,000 wages, new employer approx. 2.7%</td></tr>
                <tr><td>Workers&rsquo; Comp Work Injury Insurance</td><td>~0.5 - 2%</td><td>&ndash;</td><td>5+ employees mandatory, by industry risk rate</td></tr>
          ...
          <p class="cg-table-note">USA has no statutory paid annual leave / sick leave (federal level). FICA combined: employer 7.65% + employee 7.65%. Tennessee has no state mandatory paid sick leave.</p>
`,

  'cg.usa-tennessee.s3.b2': `
          <p class="au-table-title">Employer Statutory Additional Cost Summary (Tennessee, as % of Base Salary)</p>
          <p class="au-section-sub">FICA 7.65%, FUTA 0.6%, SUTA 0.01 - 10%, Work Injury ~0.5 - 2%</p>
...
`,
  ...
  'cg.usa-tennessee.s4.h': `Personal Income Tax`,

  'cg.usa-tennessee.s4.sub': `Federal progressive 7 tiers (employer monthly withholding W-4) + State income tax. Fiscal year 1/1 - 12/31, April filing.`,
...
`,
  ...
  'cg.usa-tennessee.s4.b2': `
          <p class="au-section-title">State Income Tax TN &mdash; No State Personal Income Tax</p>
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Tennessee has no state personal income tax, wages / salary completely exempt from state tax</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Hall Tax (Investment interest / Dividend tax) fully abolished in 2021, now only federal individual tax applies</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>State revenue primarily from sales tax (State 7% + Local up to 2.75%, combined approx. 9.55%)</span>
            </li>
          </ul>
`,

  'cg.usa-tennessee.s5.h': `Working Hours`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Daily Working Hours Cap</td><td>No federal cap</td><td>By 40h/week calculation, TN state no additional daily cap</td></tr>
                <tr><td>Weekly Rest Day</td><td>No federal mandate</td><td>Determined by employer / contract</td></tr>
                <tr><td>Meal / Rest Breaks</td><td>No federal mandate</td><td>Tennessee: Consecutive work 6h must have 30-minute meal break</td></tr>
...
`,
  ...
  'cg.usa-tennessee.s5.b2': `
          ...
          <ul class="au-bullet-list">
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Tennessee has no state overtime law, fully applies federal FLSA 1.5&times; standard</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Most US states do not mandate daily overtime calculation. Only California and a few states calculate by 8h/day. TN calculates by 40h/week</span>
            </li>
          </ul>
`,

  'cg.usa-tennessee.s6.h': `Employment Contracts`,
  ...
  'cg.usa-tennessee.s6.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>At-Will Employment</td><td>Default form</td><td>Employer / Employee can terminate at any time without cause (TN applicable)</td></tr>
                ...
                <tr><td>Non-Compete (Non-Compete)</td><td>Limited enforceability</td><td>FTC proposed nationwide ban (pending), TN current regulations</td></tr>
                <tr><td>Probation Period Probation</td><td>Typically 90 days</td><td>Under At-Will, probation period has limited legal significance</td></tr>
              </tbody>
            </table>
          </div>
...
`,
  ...
  'cg.usa-tennessee.s7.h': `Leave Entitlements`,
            ...
            <table class="au-table" style="table-layout:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Employer discretion, Tennessee has no paid sick leave law</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>FMLA 12 weeks unpaid, TN no state paid maternity leave</td>
                </tr>
                <tr>
...
`,
  ...
  'cg.usa-tennessee.s8.h': `Public Holidays 2026`,

  'cg.usa-tennessee.s8.sub': `Total 11 federal holidays (Banks / Government holidays). Private employers not mandatory paid. TN additionally designates some state holidays.`,
  ...
  'cg.usa-tennessee.s8.b1': `
          ...
          <p class="cg-table-note">Federal holidays only bind federal institutions and banks. Private enterprises may decide at their own discretion whether to grant time off / paid leave. TN additionally designates approximately 1-2 state holidays (including some memorial days).</p>
`,

  'cg.usa-tennessee.s9.h': `Key Regulations`,
  ...
  'cg.usa-tennessee.s9.b1': `
          <div class="cg-reg-item">
            ...
            <p class="cg-reg-body">Federal core labor law, stipulating minimum wage $7.25 / Overtime 1.5&times; / Child labor / Time records. Enforced by US DOL. TN applies federal standards.</p>
          </div>
          <div class="cg-reg-item">
          ...
          <div class="cg-reg-item">
            <p class="cg-reg-title">Tennessee Right-to-Work &mdash; Right-to-Work Law</p>
            <p class="cg-reg-body">Tennessee became a Right-to-Work state (2022 constitutional amendment), employees not required to join unions or pay dues to gain employment, weakening union bargaining power.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">TN Lawful Employment Act &mdash; Lawful Employment Act</p>
            <p class="cg-reg-body">Requires employers to verify work authorization through E-Verify or identity documents. 50+ employees mandatory E-Verify. Violations subject to penalties.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">ACA / COBRA / IRCA &mdash; Medical Insurance and Employment Compliance</p>
            <p class="cg-reg-body">ACA: 50+ full-time employee employers must provide medical insurance. COBRA: Post-termination continuation coverage 18 months. IRCA: I-9 form verifying work authorization (E-Verify 50+ mandatory).</p>
          </div>
`,
};

...
window.MARCO_LANG_EN_CG_USA_NEVADA = {
  ...
  'cg.usa-nevada.kn3.note': `No state personal income tax, levies MBT payroll tax`,

  'cg.usa-nevada.s1.h': `Cost of Living`,

  'cg.usa-nevada.s1.title': `City consumption level: Las Vegas / Reno / Carson City`,

  'cg.usa-nevada.s1.sub': `Based on publicly available consumption data, for reference only (US$ US Dollar, 2026 early)`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Public Transit Monthly Pass (Reno RTC)</td><td>Approx. $ 65</td></tr>
                <tr><td>City Center 1 Bedroom (Reno Downtown)</td><td>Approx. $ 1,400 &ndash; 1,900 / Month</td></tr>
                <tr><td>Suburban 1 Bedroom (Sparks)</td><td>Approx. $ 1,200 &ndash; 1,600 / Month</td></tr>
                <tr><td>Single Person Minimum Monthly Expenses</td><td>Approx. $ 1,100 &ndash; 1,700 (Excluding Rent)</td></tr>
                <tr><td>Single Person Decent Living (Including Rent, Month)</td><td>Approx. $ 2,800 &ndash; 4,000</td></tr>
              </tbody>
            </table>
          </div>
`,

  'cg.usa-nevada.s2.h': `Salary Benchmark`,

  'cg.usa-nevada.s2.sub': `Nevada 2024/7 unified minimum wage $12.00/hour (Abolished previous $11/$12 two-tier system), no state personal tax. Tourism / Logistics / Data center hub.`,

  'cg.usa-nevada.s2.b1': `
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Nevada household income median approximately $71,000/year. Reno manufacturing / Logistics / Technology (Tesla Gigafactory) growing rapidly</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Tourism/Gaming (Las Vegas), Logistics warehousing (Reno), Manufacturing (Tesla / Panasonic Gigafactory) as pillars</span>
            </li>
          </ul>
`,
  ...
  'cg.usa-nevada.s2.b2': `
          ...
          <p class="cg-table-note">Note: Reno (Tesla Gigafactory / Logistics), Las Vegas (Gaming / Conventions), no state personal tax + proximity to California attracts enterprises.</p>
`,

  'cg.usa-nevada.s3.h': `Statutory Benefits`,

  'cg.usa-nevada.s3.sub': `Federal social insurance (FICA) employer-employee split contribution + Federal/State unemployment insurance (FUTA/SUTA, employer sole contribution) + Work injury insurance`,
  ...
  'cg.usa-nevada.s3.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>SUTA NV State Unemployment Tax</td><td>0.25 - 5.4%</td><td>&ndash;</td><td>First approx. $41,800 wages, new employer 2.95%</td></tr>
          ...
          <p class="cg-table-note">USA has no statutory paid annual leave / sick leave (federal level). FICA combined: employer 7.65% + employee 7.65%. Nevada 50+ employee employers must provide paid sick leave (any reason).</p>
`,

  'cg.usa-nevada.s3.b2': `
          <p class="au-table-title">Employer Statutory Additional Cost Summary (Nevada, as % of Base Salary)</p>
          <p class="au-section-sub">FICA 7.65%, FUTA 0.6%, SUTA 0.25 - 5.4%, Work Injury ~0.5 - 2%</p>
...
`,
  ...
  'cg.usa-nevada.s4.h': `Personal Income Tax`,

  'cg.usa-nevada.s4.sub': `Federal progressive 7 tiers (employer monthly withholding W-4) + State income tax. Fiscal year 1/1 - 12/31, April filing.`,
...
`,
  ...
  'cg.usa-nevada.s4.b2': `
          <p class="au-section-title">State Income Tax NV &mdash; No State Personal Income Tax</p>
          <ul class="au-bullet-list">
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Nevada has no state personal income tax, wages / salary completely exempt from state tax</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Employers pay MBT (Modified Business Tax, payroll tax) generally 1.17% (Quarterly &gt; $50,000 portion)</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>State revenue primarily from sales tax (Combined approx. 8.375% Reno) + gaming tax</span>
            </li>
          </ul>
`,

  'cg.usa-nevada.s5.h': `Working Hours`,
          ...
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                ...
                <tr><td>Daily Working Hours Cap</td><td>No federal cap</td><td>By 40h/week calculation, NV state no additional daily cap</td></tr>
                <tr><td>Weekly Rest Day</td><td>No federal mandate</td><td>Determined by employer / contract</td></tr>
                <tr><td>Meal / Rest Breaks</td><td>No federal mandate</td><td>Nevada: 8h shift must have 30-minute meal break + every 4h 10-minute paid break</td></tr>
...
`,
  ...
  'cg.usa-nevada.s5.b2': `
          ...
          <ul class="au-bullet-list">
            ...
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Nevada special: Hourly rate &lt; 1.5&times; minimum wage workers calculate OT by 8h/day (Daily overtime rule)</span>
            </li>
            <li class="au-bullet-item">
              <div class="au-bullet-dot-wrap"><div class="au-bullet-dot"></div></div>
              <span>Most US states do not mandate daily overtime calculation. Only California and a few states calculate by 8h/day. NV calculates by 40h/week</span>
            </li>
          </ul>
`,

  'cg.usa-nevada.s6.h': `Employment Contracts`,
  ...
  'cg.usa-nevada.s6.b1': `
          <div class="au-table-wrap">
            <table class="au-table">
              ...
              <tbody>
                <tr><td>At-Will Employment</td><td>Default form</td><td>Employer / Employee can terminate at any time without cause (NV applicable)</td></tr>
                ...
                <tr><td>Non-Compete (Non-Compete)</td><td>Enforceable (Limited)</td><td>FTC proposed nationwide ban (pending), NV current regulations</td></tr>
...
`,
  ...
  'cg.usa-nevada.s7.h': `Leave Entitlements`,
            ...
            <table class="au-table" style="table-layout:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>State mandatory (SB312)</td>
                  <td>50+ employees, approx. 40h annually, any reason available</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>FMLA 12 weeks unpaid, NV no state paid maternity leave</td>
                </tr>
                <tr>
...
`,
  ...
  'cg.usa-nevada.s8.h': `Public Holidays 2026`,

  'cg.usa-nevada.s8.sub': `Total 11 federal holidays (Banks / Government holidays). Private employers not mandatory paid. NV additionally designates several state holidays.`,
  ...
  'cg.usa-nevada.s8.b1': `
          ...
          <p class="cg-table-note">Federal holidays only bind federal institutions and banks. Private enterprises may decide at their own discretion whether to grant time off / paid leave. NV additionally designates approximately 1-2 state holidays.</p>
`,

  'cg.usa-nevada.s9.h': `Key Regulations`,

  'cg.usa-nevada.s9.b1': `
          <div class="cg-reg-item">
            <p class="cg-reg-title">FLSA Fair Labor Standards Act &mdash; Fair Labor Standards Act</p>
            <p class="cg-reg-body">Federal core labor law, stipulating minimum wage $7.25 / Overtime 1.5&times; / Child labor / Time records. Enforced by US DOL. NV applies federal standards.</p>
          </div>
          <div class="cg-reg-item">
          ...
          <div class="cg-reg-item">
            <p class="cg-reg-title">Nevada Paid Leave Law (SB 312) &mdash; Paid Leave Act</p>
            <p class="cg-reg-body">50+ employee employers must accrue 0.01923 hours paid leave per 1 hour worked, annual cap approximately 40 hours, any reason available.</p>
          </div>
          <div class="cg-reg-item">
            <p class="cg-reg-title">Nevada Right-to-Work + MBT &mdash; Right-to-Work + Payroll Tax</p>
            <p class="cg-reg-body">Right-to-Work state (No mandatory union membership). Employers pay Modified Business Tax payroll tax (generally 1.17%), replacing state personal tax revenue.</p>
          </div>
          <div class="cg-reg-item">

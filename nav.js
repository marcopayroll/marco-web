(function () {
  ...
  var NAV_HTML = [
    ...
    '            <div class="nav-dropdown-divider"></div>',
    '            <div class="nav-dropdown-list">',
    '              <a class="nav-resources-item" href="marco-os.html">',
    '                <div class="nav-resources-item-icon"><img src="assets/Resources/marco-os-icon.svg" alt=""></div>',
    '                <div class="nav-resources-item-text"><span class="nav-resources-item-title" data-i18n="nav.dd.marcos.title">Marco OS</span><span class="nav-resources-item-desc" data-i18n="nav.dd.marcos.desc">Single platform for global workforce management</span></div>',
    '              </a>',
    ...
    '            <div class="nav-dropdown-divider"></div>',
    '            <div class="nav-dropdown-list">',
    '              <a class="nav-about-item" href="price-global-workforce-solution.html"><div class="nav-about-item-icon"><img src="assets/Price/Global Workforce Solution.svg" alt=""></div><div class="nav-about-item-text"><span class="nav-about-item-title" data-i18n="nav.dd.gws.title">Global Workforce Solution</span><span class="nav-about-item-desc" data-i18n="nav.dd.gws.desc">Service pricing for global workforce administration</span></div></a>',
    '              <a class="nav-about-item" href="price-global-managed-payroll-service.html"><div class="nav-about-item-icon"><img src="assets/Price/Global Managed Payroll Service.svg" alt=""></div><div class="nav-about-item-text"><span class="nav-about-item-title" data-i18n="nav.dd.gmps.title">Global Managed Payroll Service</span><span class="nav-about-item-desc" data-i18n="nav.dd.gmps.desc">Managed payroll pricing for global teams</span></div></a>',
    '              <a class="nav-about-item" href="price-proposal-builder.html"><div class="nav-about-item-icon"><img src="assets/Price/Proposal builder.svg" alt=""></div><div class="nav-about-item-text"><span class="nav-about-item-title" data-i18n="nav.dd.proposal.title">Proposal Builder</span><span class="nav-about-item-desc" data-i18n="nav.dd.proposal.desc">Build a tailored service pricing proposal</span></div></a>',
    '            </div>',
    '          </div>',
    '        </div>',
    ...
    '      <div class="nav-mob-body">',
    '        <a class="nav-mob-sub-item" href="marco-os.html"><div class="nav-mob-sub-icon"><img src="assets/Resources/marco-os-icon.svg" alt=""></div><div class="nav-mob-sub-text"><span class="nav-mob-sub-title" data-i18n="nav.dd.marcos.title">Marco OS</span><span class="nav-mob-sub-desc" data-i18n="nav.dd.marcos.desc">Single platform for global workforce management</span></div></a>',
    ...
    '      <div class="nav-mob-body">',
    '        <a class="nav-mob-sub-item" href="price-global-workforce-solution.html"><div class="nav-mob-sub-icon"><img src="assets/Price/Global Workforce Solution.svg" alt=""></div><div class="nav-mob-sub-text"><span class="nav-mob-sub-title" data-i18n="nav.dd.gws.title">Global Workforce Solution</span><span class="nav-mob-sub-desc" data-i18n="nav.dd.gws.desc">Service pricing for global workforce administration</span></div></a>',
    '        <a class="nav-mob-sub-item" href="price-global-managed-payroll-service.html"><div class="nav-mob-sub-icon"><img src="assets/Price/Global Managed Payroll Service.svg" alt=""></div><div class="nav-mob-sub-text"><span class="nav-mob-sub-title" data-i18n="nav.dd.gmps.title">Global Managed Payroll Service</span><span class="nav-mob-sub-desc" data-i18n="nav.dd.gmps.desc">Managed payroll pricing for global teams</span></div></a>',
    '        <a class="nav-mob-sub-item" href="price-proposal-builder.html"><div class="nav-mob-sub-icon"><img src="assets/Price/Proposal builder.svg" alt=""></div><div class="nav-mob-sub-text"><span class="nav-mob-sub-title" data-i18n="nav.dd.proposal.title">Proposal Builder</span><span class="nav-mob-sub-desc" data-i18n="nav.dd.proposal.desc">Build a tailored service pricing proposal</span></div></a>',
    '      </div>',
    '    </div>',
